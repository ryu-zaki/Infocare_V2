namespace Infocare_Project
{
    partial class AdminAddDoctor
    {
        ...
        private void InitializeComponent()
        {
            ...
            removeDoctor.CustomizableEdges = customizableEdges1;
            removeDoctor.DisabledState.BorderColor = Color.DarkGray;
            removeDoctor.DisabledState.CustomBorderColor = Color.DarkGray;
            removeDoctor.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            removeDoctor.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            removeDoctor.FillColor = Color.Red;
            removeDoctor.Font = new Font("Microsoft Sans Serif", 11.999999F, FontStyle.Regular, GraphicsUnit.Point);
            removeDoctor.ForeColor = Color.White;
            removeDoctor.Location = new Point(545, 524);
            removeDoctor.Margin = new Padding(3, 2, 3, 2);
            removeDoctor.Name = "removeDoctor";
            removeDoctor.ShadowDecoration.CustomizableEdges = customizableEdges2;
            removeDoctor.Size = new Size(164, 42);
            removeDoctor.TabIndex = 186;
